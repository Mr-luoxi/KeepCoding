...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly fetchSuggestions: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("./autocomplete").AutocompleteFetchSuggestions>, () => void, unknown, unknown, unknown>;
