export declare const ElDropdown: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly buttonProps: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("..").ButtonProps>, unknown, unknown, unknown, unknown>;
}, {
    ns: {
