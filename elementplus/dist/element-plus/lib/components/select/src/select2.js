...
var tag = require('../../tag/src/tag4.js');
  ...
  setup(props, ctx) {
    ...
    vue.onMounted(() => {
      ...
      if (reference.value && reference.value.$el) {
        ...
        states.initialInputHeight = input2.getBoundingClientRect().height || size.getComponentSize(selectSize.value);
      }
...
var Select = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["render", _sfc_render], ["__file", "/Users/luoxi/Downloads/1-\u57F9\u8BAD\u51C6\u5907\u6587\u6863/element-plus-dev/packages/components/select/src/select.vue"]]);
