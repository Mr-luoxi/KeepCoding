...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly buttonProps: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("element-plus/es/components/button").ButtonProps>, unknown, unknown, unknown, unknown>;
}, {
    ns: {
    ...
    showTimeout: number;
    hideTimeout: number;
    buttonProps: import("element-plus/es/components/button").ButtonProps;
    splitButton: boolean;
}>;
