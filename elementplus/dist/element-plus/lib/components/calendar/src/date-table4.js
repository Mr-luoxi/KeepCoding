  ...
  setup(__props, { expose, emit }) {
    ...
    const rows = vue.computed(() => {
      ...
      if (isInRange.value) {
        ...
        const nextMonthDays = dateUtils.rangeArr(remaining).map((_, index) => ({
          text: index + 1,
          type: "next"
        }));
...
var DateTable = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "/Users/luoxi/Downloads/1-\u57F9\u8BAD\u51C6\u5907\u6587\u6863/element-plus-dev/packages/components/calendar/src/date-table.vue"]]);
