export declare const ElAutocomplete: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly fetchSuggestions: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("./src/autocomplete").AutocompleteFetchSuggestions>, () => void, unknown, unknown, unknown>;
    ...
    emit: ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string) => void) & ((event: "input", value: string) => void) & ((event: "blur", evt: FocusEvent) => void) & ((event: "focus", evt: FocusEvent) => void) & ((event: "select", item: {
        value: any;
    ...
    fetchSuggestions: import("./src/autocomplete").AutocompleteFetchSuggestions;
    popperClass: string;
