...
export declare const autocompleteProps: {
    ...
    readonly fetchSuggestions: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<AutocompleteFetchSuggestions>, () => void, unknown, unknown, unknown>;
