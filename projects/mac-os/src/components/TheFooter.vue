<template>
  <div class="text-center">
    <el-tooltip :content="t('home')" placement="top">
      <router-link class="mx-2 icon-btn" to="/">
    ...
    <el-tooltip :content="t('change lang')" placement="top">
      <button class="mx-2 icon-btn" @click="toggleLocales()">
        <i-la-language class="icon-footer" />
      </button>
    </el-tooltip>

    <el-tooltip :content="t('method to using')" placement="top">
      <router-link class="mx-2 icon-btn" to="/process">
        <i-ri-article-line class="icon-footer" />
      </router-link>
    </el-tooltip>

    <el-tooltip :content="t('template process')" placement="top">
      <a class="mx-2 icon-btn" href="https://juejin.cn/post/7058201396113309703" target="_blank" title="JveJin">
        <i-mdi-content-duplicate class="icon-footer" />
      </a>
    </el-tooltip>

    <el-tooltip content="GitHub" placement="top">
      <a class="mx-2 icon-btn" href="https://github.com/nekobc1998923/vitecamp" target="_blank" title="GitHub">
